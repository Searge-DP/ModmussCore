...
public class GuiMainMenu extends GuiScreen {
					...
					public void run() {
						...
						for (int i = 0; i < 3; ++i) {
							try {
								...
								GuiMainMenu.field_96139_s = obool
										.booleanValue();
	...
	private void addSingleplayerMultiplayerButtons(int par1, int par2) {
		this.buttonList.add(new GuiButton(1, this.width / 2 - 100, par1, I18n
				.format("menu.singleplayer", new Object[0])));
		this.buttonList.add(new GuiButton(2, this.width / 2 - 100, par1 + par2
		...
		fmlModButton = new GuiButton(6, this.width / 2 - 100, par1 + par2 * 2,
				"Mods");
			...
			if (par1) {
				try {
					...
					oclass.getMethod("browse", new Class[]{URI.class}).invoke(
							object, new Object[]{new URI(this.field_104024_v)});
