package me.modmuss50.mods.lib.api;
...
public class Colors {
	...
	public static int Brown = itemColors[3];
	public static int Blue = itemColors[4];
	public static int Purple = itemColors[5];
	public static int Cyan = itemColors[6];
	public static int LightGrey = itemColors[7];
	public static int Grey = itemColors[8];
	public static int Pink = itemColors[9];
	public static int Lime = itemColors[10];
	public static int Yellow = itemColors[11];
	public static int LightBlue = itemColors[12];
