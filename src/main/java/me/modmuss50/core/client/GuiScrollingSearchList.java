...
public abstract class GuiScrollingSearchList {
	...
	public GuiScrollingSearchList(Minecraft client, int width, int height, int top, int bottom, int left, int entryHeight) {
		this.client = client;
