...
public abstract class Transactor implements ITransactor {
	...
	@Override
	public ItemStack add(ItemStack stack, ForgeDirection orientation,
			boolean doAdd) {
	...
	public abstract int inject(ItemStack stack, ForgeDirection orientation,
			boolean doAdd);
	...
	public static ITransactor getTransactorFor(Object object) {
		...
		if (object instanceof ISidedInventory)
			...
			return new TransactorSimple(
					invUtil.getInventory((IInventory) object));
